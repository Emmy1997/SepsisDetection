...
def training_models(train_X, train_Y, val_X, val_Y, features_set):
    ...
    return   best_params_xgb, best_score_xgb, xgb_f1_scores
...
def evaluate_all_models(train_X, train_Y, val_X, val_Y, features_set, i):
    ...
    # best_k, best_score_knn, knn_f1_scores, \
    #     best_n_max_depth_rf, best_score_rf, rf_f1_scores, \
    best_params_xgb, best_score_xgb, xgb_f1_scores = training_models(train_X, train_Y, val_X, val_Y, features_set)
    # best_params_cat, best_score_cat, cat_f1_scores
    ...
    results_dict = {
        # 'KNN': [best_k, best_score_knn, knn_f1_scores],
    ...
    json_to_save = json.dumps(results_dict)
    with open(f'results_dict/results_dict_experiment_{i}.txt', 'w') as f:
...
for i in [9]:
    ...
    val_df_p2y = val_df[['level_0','index', 'patient', 'y', 'Unnamed: 0']]
